...
let Calendar = React.createClass({
  ...
  getInitialState() {
    return {
      ...
      selectedDate: moment(new Date(this.props.selectedDate)).format(),
      currentMonth: moment(new Date(this.props.startDate)).format()
    };
  },
  ...
  getInitialStack() {
    ...
    if (this.props.scrollEnabled) {
      initialStack.push(moment(new Date(this.props.startDate)).subtract(2, 'month').format());
      initialStack.push(moment(new Date(this.props.startDate)).subtract(1, 'month').format());
      initialStack.push(moment(new Date(this.props.startDate)).format());
      initialStack.push(moment(new Date(this.props.startDate)).add(1, 'month').format());
      initialStack.push(moment(new Date(this.props.startDate)).add(2, 'month').format());
    } else {
      initialStack.push(moment(new Date(this.props.startDate)).format())
    }
    return initialStack;
